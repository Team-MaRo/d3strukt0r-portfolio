...
export function TaBg() {
  return (
    <div aria-hidden className="ta-bg pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      <div className="ta-blob-1 absolute -top-60 -right-40 h-160 w-160 animate-ta-float rounded-full opacity-40 blur-[130px] dark:opacity-45" />
      <div className="ta-blob-2 absolute top-1/3 -left-48 h-150 w-150 animate-ta-float2 rounded-full opacity-35 blur-[140px] dark:opacity-40" />
      <div className="ta-blob-3 absolute -bottom-52 left-1/3 h-140 w-140 animate-ta-float rounded-full opacity-30 blur-[140px] dark:opacity-35" />
